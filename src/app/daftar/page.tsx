...
export default function Daftar() {
  ...
  return (
    <div className={styles.pageWrapper}>
      {/* Navbar - Reuse from Home */}
      <header className={sharedStyles.header}>
        <div className={sharedStyles.logo}>
          <div className={sharedStyles.logoImg}>
            <svg viewBox="0 0 24 24" fill="#0f172a">
              <path d="M12 2L2 12h3v8h6v-6h2v6h6v-8h3L12 2z"/>
            </svg>
          </div>
          <div className={sharedStyles.logoText}>ASSURUUR</div>
        </div>
        <nav className={sharedStyles.nav}>
          <Link href="/" className={sharedStyles.navLink}>Home</Link>
          <Link href="#" className={sharedStyles.navLink}>Profile</Link>
          <Link href="#contact" className={sharedStyles.navLink}>Contact</Link>
          <Link href="/daftar" className={sharedStyles.btnPrimary}>Daftar Sekarang</Link>
        </nav>
      </header>
      ...
      <footer id="contact" className={sharedStyles.footer}>
        <div className={sharedStyles.footerGrid}>
          <div className={sharedStyles.footerCol}>
            <h3>Tentang Kami</h3>
          ...
          <div className={sharedStyles.footerCol}>
            <div className={sharedStyles.socialIcons}>
              <a href="#" className={sharedStyles.socialIcon}>
          ...
          <div className={sharedStyles.footerCol}>
            ...
            <div className={sharedStyles.contactItem}>
              <div className={sharedStyles.contactIcon}>
        ...
        <div className={sharedStyles.footerCopyright}>
          &copy; {new Date().getFullYear()} Pondok Pesantren Modern ASSURUUR. All rights reserved.
        </div>
      </footer>

      {/* WhatsApp Float */}
      <a href="#" className={sharedStyles.whatsappFloat}>
